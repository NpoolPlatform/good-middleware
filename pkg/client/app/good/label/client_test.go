...
func createLabel(t *testing.T) {
	err := CreateLabel(context.Background(), &npool.LabelReq{
		EntID:        &ret.EntID,
		AppGoodID:    &ret.AppGoodID,
		Icon:         &ret.Icon,
		IconBgColor:  &ret.IconBgColor,
		Label:        &ret.Label,
		LabelBgColor: &ret.LabelBgColor,
		Index:        &ret.Index,
	})
	if assert.Nil(t, err) {
...
//nolint
func getLabelOnly(t *testing.T) {
	info, err := GetLabelOnly(context.Background(), &npool.Conds{
		ID:         &basetypes.Uint32Val{Op: cruder.EQ, Value: ret.ID},
		EntID:      &basetypes.StringVal{Op: cruder.EQ, Value: ret.EntID},
		AppID:      &basetypes.StringVal{Op: cruder.EQ, Value: ret.AppID},
		AppGoodID:  &basetypes.StringVal{Op: cruder.EQ, Value: ret.AppGoodID},
...
func deleteLabel(t *testing.T) {
	err := DeleteLabel(context.Background(), &ret.ID, &ret.EntID)
	assert.Nil(t, err)
...
func TestLabel(t *testing.T) {
	...
	t.Run("getLabelOnly", getLabelOnly)
