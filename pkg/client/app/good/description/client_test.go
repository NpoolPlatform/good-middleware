...
func createDescription(t *testing.T) {
	err := CreateDescription(context.Background(), &npool.DescriptionReq{
		EntID:       &ret.EntID,
		AppGoodID:   &ret.AppGoodID,
	...
	if assert.Nil(t, err) {
		info, err := GetDescription(context.Background(), ret.EntID)
		if assert.Nil(t, err) {
...
func updateDescription(t *testing.T) {
	err := UpdateDescription(context.Background(), &npool.DescriptionReq{
		ID:          &ret.ID,
		Description: &ret.Description,
	})
	if assert.Nil(t, err) {
...
//nolint
func getDescriptionOnly(t *testing.T) {
	info, err := GetDescriptionOnly(context.Background(), &npool.Conds{
		ID:         &basetypes.Uint32Val{Op: cruder.EQ, Value: ret.ID},
		EntID:      &basetypes.StringVal{Op: cruder.EQ, Value: ret.EntID},
		AppID:      &basetypes.StringVal{Op: cruder.EQ, Value: ret.AppID},
		AppGoodID:  &basetypes.StringVal{Op: cruder.EQ, Value: ret.AppGoodID},
...
func deleteDescription(t *testing.T) {
	err := DeleteDescription(context.Background(), &ret.ID, &ret.EntID)
	assert.Nil(t, err)
...
func TestDescription(t *testing.T) {
	...
	t.Run("getDescriptionOnly", getDescriptionOnly)
