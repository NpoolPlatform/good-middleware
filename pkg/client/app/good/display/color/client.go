...
func ExistDisplayColorConds(ctx context.Context, conds *npool.Conds) (bool, error) {
	info, err := withClient(ctx, func(_ctx context.Context, cli npool.MiddlewareClient) (interface{}, error) {
		resp, err := cli.ExistDisplayColorConds(ctx, &npool.ExistDisplayColorCondsRequest{
			Conds: conds,
		})
		if err != nil {
			return false, err
