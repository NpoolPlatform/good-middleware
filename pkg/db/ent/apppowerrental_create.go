...
func (aprc *AppPowerRentalCreate) Save(ctx context.Context) (*AppPowerRental, error) {
	...
	if len(aprc.hooks) == 0 {
		...
		var mut Mutator = MutateFunc(func(ctx context.Context, m Mutation) (Value, error) {
			...
			aprc.mutation = mutation
			if node, err = aprc.sqlSave(ctx); err != nil {
				return nil, err
			}
			mutation.id = &node.ID
			mutation.done = true
		...
		for i := len(aprc.hooks) - 1; i >= 0; i-- {
			if aprc.hooks[i] == nil {
				return nil, fmt.Errorf("ent: uninitialized hook (forgotten import ent/runtime?)")
			}
			mut = aprc.hooks[i](mut)
		}
		v, err := mut.Mutate(ctx, aprc.mutation)
		if err != nil {
			return nil, err
		}
		nv, ok := v.(*AppPowerRental)
		if !ok {
			return nil, fmt.Errorf("unexpected node type %T returned from AppPowerRentalMutation", v)
		}
		node = nv
	}
	return node, err
...
func (aprc *AppPowerRentalCreate) defaults() error {
	if _, ok := aprc.mutation.CreatedAt(); !ok {
		if apppowerrental.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized apppowerrental.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := apppowerrental.DefaultCreatedAt()
		aprc.mutation.SetCreatedAt(v)
	}
	if _, ok := aprc.mutation.UpdatedAt(); !ok {
		if apppowerrental.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized apppowerrental.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := apppowerrental.DefaultUpdatedAt()
		aprc.mutation.SetUpdatedAt(v)
	}
	if _, ok := aprc.mutation.DeletedAt(); !ok {
		if apppowerrental.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized apppowerrental.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := apppowerrental.DefaultDeletedAt()
		aprc.mutation.SetDeletedAt(v)
	}
	if _, ok := aprc.mutation.EntID(); !ok {
		if apppowerrental.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized apppowerrental.DefaultEntID (forgotten import ent/runtime?)")
		}
...
func (aprc *AppPowerRentalCreate) check() error {
	if _, ok := aprc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "AppPowerRental.created_at"`)}
	}
	if _, ok := aprc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "AppPowerRental.updated_at"`)}
	}
	if _, ok := aprc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "AppPowerRental.deleted_at"`)}
	}
	if _, ok := aprc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "AppPowerRental.ent_id"`)}
	}
	return nil
}
...
func (aprc *AppPowerRentalCreate) createSpec() (*AppPowerRental, *sqlgraph.CreateSpec) {
	...
	if value, ok := aprc.mutation.CreatedAt(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: apppowerrental.FieldCreatedAt,
		})
	...
	if value, ok := aprc.mutation.UpdatedAt(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: apppowerrental.FieldUpdatedAt,
		})
	...
	if value, ok := aprc.mutation.DeletedAt(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: apppowerrental.FieldDeletedAt,
		})
	...
	if value, ok := aprc.mutation.CancelMode(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: apppowerrental.FieldCancelMode,
		})
	...
	if value, ok := aprc.mutation.CancelableBeforeStartSeconds(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: apppowerrental.FieldCancelableBeforeStartSeconds,
		})
	...
	if value, ok := aprc.mutation.EnableSetCommission(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeBool,
			Value:  value,
			Column: apppowerrental.FieldEnableSetCommission,
		})
	...
	if value, ok := aprc.mutation.MinOrderAmount(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			...
			Value:  value,
			Column: apppowerrental.FieldMinOrderAmount,
		})
	...
	if value, ok := aprc.mutation.MaxOrderAmount(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeOther,
			Value:  value,
			Column: apppowerrental.FieldMaxOrderAmount,
		})
	...
	if value, ok := aprc.mutation.SaleStartAt(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: apppowerrental.FieldSaleStartAt,
		})
...
func (u *AppPowerRentalUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for AppPowerRentalCreate.OnConflict")
	}
...
func (u *AppPowerRentalUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the AppPowerRentalCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for AppPowerRentalCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
