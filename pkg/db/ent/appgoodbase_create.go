...
func (agbc *AppGoodBaseCreate) Save(ctx context.Context) (*AppGoodBase, error) {
	...
	if len(agbc.hooks) == 0 {
		...
		var mut Mutator = MutateFunc(func(ctx context.Context, m Mutation) (Value, error) {
			...
			agbc.mutation = mutation
			if node, err = agbc.sqlSave(ctx); err != nil {
				return nil, err
			}
			mutation.id = &node.ID
			mutation.done = true
		...
		for i := len(agbc.hooks) - 1; i >= 0; i-- {
			if agbc.hooks[i] == nil {
				return nil, fmt.Errorf("ent: uninitialized hook (forgotten import ent/runtime?)")
			}
			mut = agbc.hooks[i](mut)
		}
		v, err := mut.Mutate(ctx, agbc.mutation)
		if err != nil {
			return nil, err
		}
		nv, ok := v.(*AppGoodBase)
...
func (agbc *AppGoodBaseCreate) defaults() error {
	if _, ok := agbc.mutation.CreatedAt(); !ok {
		if appgoodbase.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized appgoodbase.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := appgoodbase.DefaultCreatedAt()
		agbc.mutation.SetCreatedAt(v)
	}
	if _, ok := agbc.mutation.UpdatedAt(); !ok {
		if appgoodbase.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized appgoodbase.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := appgoodbase.DefaultUpdatedAt()
		agbc.mutation.SetUpdatedAt(v)
	}
	if _, ok := agbc.mutation.DeletedAt(); !ok {
		if appgoodbase.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized appgoodbase.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := appgoodbase.DefaultDeletedAt()
		agbc.mutation.SetDeletedAt(v)
	}
	if _, ok := agbc.mutation.EntID(); !ok {
		if appgoodbase.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized appgoodbase.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := appgoodbase.DefaultEntID()
		agbc.mutation.SetEntID(v)
	}
	if _, ok := agbc.mutation.AppID(); !ok {
		if appgoodbase.DefaultAppID == nil {
			return fmt.Errorf("ent: uninitialized appgoodbase.DefaultAppID (forgotten import ent/runtime?)")
		}
		v := appgoodbase.DefaultAppID()
		agbc.mutation.SetAppID(v)
	}
	if _, ok := agbc.mutation.GoodID(); !ok {
		if appgoodbase.DefaultGoodID == nil {
			return fmt.Errorf("ent: uninitialized appgoodbase.DefaultGoodID (forgotten import ent/runtime?)")
		}
...
func (agbc *AppGoodBaseCreate) check() error {
	if _, ok := agbc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "AppGoodBase.created_at"`)}
	}
	if _, ok := agbc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "AppGoodBase.updated_at"`)}
	}
	if _, ok := agbc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "AppGoodBase.deleted_at"`)}
	}
	if _, ok := agbc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "AppGoodBase.ent_id"`)}
	}
	return nil
}
...
func (u *AppGoodBaseUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for AppGoodBaseCreate.OnConflict")
	}
...
func (u *AppGoodBaseUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the AppGoodBaseCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for AppGoodBaseCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
