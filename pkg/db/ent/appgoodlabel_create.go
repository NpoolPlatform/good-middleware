...
func (aglc *AppGoodLabelCreate) Save(ctx context.Context) (*AppGoodLabel, error) {
	...
	if len(aglc.hooks) == 0 {
		...
		var mut Mutator = MutateFunc(func(ctx context.Context, m Mutation) (Value, error) {
			...
			aglc.mutation = mutation
			if node, err = aglc.sqlSave(ctx); err != nil {
				return nil, err
			}
			mutation.id = &node.ID
			mutation.done = true
		...
		for i := len(aglc.hooks) - 1; i >= 0; i-- {
			if aglc.hooks[i] == nil {
				return nil, fmt.Errorf("ent: uninitialized hook (forgotten import ent/runtime?)")
			}
			mut = aglc.hooks[i](mut)
		}
		v, err := mut.Mutate(ctx, aglc.mutation)
		if err != nil {
			return nil, err
		}
		nv, ok := v.(*AppGoodLabel)
		if !ok {
			return nil, fmt.Errorf("unexpected node type %T returned from AppGoodLabelMutation", v)
		}
		node = nv
	}
	return node, err
...
func (aglc *AppGoodLabelCreate) defaults() error {
	if _, ok := aglc.mutation.CreatedAt(); !ok {
		if appgoodlabel.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized appgoodlabel.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := appgoodlabel.DefaultCreatedAt()
		aglc.mutation.SetCreatedAt(v)
	}
	if _, ok := aglc.mutation.UpdatedAt(); !ok {
		if appgoodlabel.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized appgoodlabel.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := appgoodlabel.DefaultUpdatedAt()
		aglc.mutation.SetUpdatedAt(v)
	}
	if _, ok := aglc.mutation.DeletedAt(); !ok {
		if appgoodlabel.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized appgoodlabel.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := appgoodlabel.DefaultDeletedAt()
		aglc.mutation.SetDeletedAt(v)
	}
	if _, ok := aglc.mutation.EntID(); !ok {
		if appgoodlabel.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized appgoodlabel.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := appgoodlabel.DefaultEntID()
		aglc.mutation.SetEntID(v)
	}
	if _, ok := aglc.mutation.AppGoodID(); !ok {
		if appgoodlabel.DefaultAppGoodID == nil {
			return fmt.Errorf("ent: uninitialized appgoodlabel.DefaultAppGoodID (forgotten import ent/runtime?)")
		}
...
func (aglc *AppGoodLabelCreate) check() error {
	if _, ok := aglc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "AppGoodLabel.created_at"`)}
	}
	if _, ok := aglc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "AppGoodLabel.updated_at"`)}
	}
	if _, ok := aglc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "AppGoodLabel.deleted_at"`)}
	}
	if _, ok := aglc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "AppGoodLabel.ent_id"`)}
	}
	return nil
}
...
func (aglc *AppGoodLabelCreate) createSpec() (*AppGoodLabel, *sqlgraph.CreateSpec) {
	...
	if value, ok := aglc.mutation.CreatedAt(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: appgoodlabel.FieldCreatedAt,
		})
	...
	if value, ok := aglc.mutation.UpdatedAt(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: appgoodlabel.FieldUpdatedAt,
		})
	...
	if value, ok := aglc.mutation.DeletedAt(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUint32,
			Value:  value,
			Column: appgoodlabel.FieldDeletedAt,
		})
	...
	if value, ok := aglc.mutation.EntID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUUID,
			Value:  value,
			Column: appgoodlabel.FieldEntID,
		})
		_node.EntID = value
	}
	if value, ok := aglc.mutation.AppGoodID(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeUUID,
			Value:  value,
			Column: appgoodlabel.FieldAppGoodID,
		})
	...
	if value, ok := aglc.mutation.IconBgColor(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: appgoodlabel.FieldIconBgColor,
		})
	...
	if value, ok := aglc.mutation.Label(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: appgoodlabel.FieldLabel,
		})
		_node.Label = value
	}
	if value, ok := aglc.mutation.LabelBgColor(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: appgoodlabel.FieldLabelBgColor,
		})
	...
	if value, ok := aglc.mutation.Index(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			...
			Value:  value,
			Column: appgoodlabel.FieldIndex,
		})
		_node.Index = value
	}
	return _node, _spec
...
func (u *AppGoodLabelUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for AppGoodLabelCreate.OnConflict")
	}
...
func (u *AppGoodLabelUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the AppGoodLabelCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for AppGoodLabelCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
