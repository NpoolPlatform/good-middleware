...
const (
	// Label holds the string label denoting the subgood type in the database.
	Label = "sub_good"
	...
	// FieldSubGoodID holds the string denoting the sub_good_id field in the database.
	FieldSubGoodID = "sub_good_id"
	...
	// Table holds the table name of the subgood in the database.
	Table = "sub_goods"
)

// Columns holds all SQL columns for subgood fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
