...
func (gbc *GoodBaseCreate) defaults() error {
	if _, ok := gbc.mutation.CreatedAt(); !ok {
		if goodbase.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized goodbase.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := goodbase.DefaultCreatedAt()
		gbc.mutation.SetCreatedAt(v)
	}
	if _, ok := gbc.mutation.UpdatedAt(); !ok {
		if goodbase.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized goodbase.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := goodbase.DefaultUpdatedAt()
		gbc.mutation.SetUpdatedAt(v)
	}
	if _, ok := gbc.mutation.DeletedAt(); !ok {
		if goodbase.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized goodbase.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := goodbase.DefaultDeletedAt()
		gbc.mutation.SetDeletedAt(v)
	}
	if _, ok := gbc.mutation.EntID(); !ok {
		if goodbase.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized goodbase.DefaultEntID (forgotten import ent/runtime?)")
		}
...
func (gbc *GoodBaseCreate) check() error {
	if _, ok := gbc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "GoodBase.created_at"`)}
	}
	if _, ok := gbc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "GoodBase.updated_at"`)}
	}
	if _, ok := gbc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "GoodBase.deleted_at"`)}
	}
	if _, ok := gbc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "GoodBase.ent_id"`)}
	}
	return nil
}
...
func (u *GoodBaseUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for GoodBaseCreate.OnConflict")
	}
...
func (u *GoodBaseUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the GoodBaseCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for GoodBaseCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
