...
const (
	// Label holds the string label denoting the stocklock type in the database.
	Label = "stock_lock"
	...
	// Table holds the table name of the stocklock in the database.
	Table = "stock_locks"
)

// Columns holds all SQL columns for stocklock fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
var (
	...
	// DefaultStockID holds the default value on creation for the "stock_id" field.
	DefaultStockID func() uuid.UUID
