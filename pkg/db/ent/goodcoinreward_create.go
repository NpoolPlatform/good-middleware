...
func (gcrc *GoodCoinRewardCreate) Save(ctx context.Context) (*GoodCoinReward, error) {
	...
	if len(gcrc.hooks) == 0 {
		...
		var mut Mutator = MutateFunc(func(ctx context.Context, m Mutation) (Value, error) {
			...
			gcrc.mutation = mutation
			if node, err = gcrc.sqlSave(ctx); err != nil {
				return nil, err
			}
			mutation.id = &node.ID
			mutation.done = true
		...
		for i := len(gcrc.hooks) - 1; i >= 0; i-- {
			if gcrc.hooks[i] == nil {
				return nil, fmt.Errorf("ent: uninitialized hook (forgotten import ent/runtime?)")
			}
			mut = gcrc.hooks[i](mut)
		}
		v, err := mut.Mutate(ctx, gcrc.mutation)
		if err != nil {
			return nil, err
		}
...
func (gcrc *GoodCoinRewardCreate) defaults() error {
	if _, ok := gcrc.mutation.CreatedAt(); !ok {
		if goodcoinreward.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized goodcoinreward.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := goodcoinreward.DefaultCreatedAt()
		gcrc.mutation.SetCreatedAt(v)
	}
	if _, ok := gcrc.mutation.UpdatedAt(); !ok {
		if goodcoinreward.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized goodcoinreward.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := goodcoinreward.DefaultUpdatedAt()
		gcrc.mutation.SetUpdatedAt(v)
	}
	if _, ok := gcrc.mutation.DeletedAt(); !ok {
		if goodcoinreward.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized goodcoinreward.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := goodcoinreward.DefaultDeletedAt()
		gcrc.mutation.SetDeletedAt(v)
	}
	if _, ok := gcrc.mutation.EntID(); !ok {
		if goodcoinreward.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized goodcoinreward.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := goodcoinreward.DefaultEntID()
		gcrc.mutation.SetEntID(v)
	}
	if _, ok := gcrc.mutation.GoodID(); !ok {
		if goodcoinreward.DefaultGoodID == nil {
			return fmt.Errorf("ent: uninitialized goodcoinreward.DefaultGoodID (forgotten import ent/runtime?)")
		}
		v := goodcoinreward.DefaultGoodID()
		gcrc.mutation.SetGoodID(v)
	}
	if _, ok := gcrc.mutation.CoinTypeID(); !ok {
		if goodcoinreward.DefaultCoinTypeID == nil {
			return fmt.Errorf("ent: uninitialized goodcoinreward.DefaultCoinTypeID (forgotten import ent/runtime?)")
		}
		v := goodcoinreward.DefaultCoinTypeID()
		gcrc.mutation.SetCoinTypeID(v)
	}
	if _, ok := gcrc.mutation.RewardTid(); !ok {
		if goodcoinreward.DefaultRewardTid == nil {
			return fmt.Errorf("ent: uninitialized goodcoinreward.DefaultRewardTid (forgotten import ent/runtime?)")
		}
...
func (gcrc *GoodCoinRewardCreate) check() error {
	if _, ok := gcrc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "GoodCoinReward.created_at"`)}
	}
	if _, ok := gcrc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "GoodCoinReward.updated_at"`)}
	}
	if _, ok := gcrc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "GoodCoinReward.deleted_at"`)}
	}
	if _, ok := gcrc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "GoodCoinReward.ent_id"`)}
	}
	return nil
}
...
func (u *GoodCoinRewardUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for GoodCoinRewardCreate.OnConflict")
	}
...
func (u *GoodCoinRewardUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the GoodCoinRewardCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for GoodCoinRewardCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
