...
func (mgsc *MiningGoodStockCreate) Save(ctx context.Context) (*MiningGoodStock, error) {
	...
	if len(mgsc.hooks) == 0 {
		...
		var mut Mutator = MutateFunc(func(ctx context.Context, m Mutation) (Value, error) {
			...
			mgsc.mutation = mutation
			if node, err = mgsc.sqlSave(ctx); err != nil {
				return nil, err
			}
			mutation.id = &node.ID
			mutation.done = true
		...
		for i := len(mgsc.hooks) - 1; i >= 0; i-- {
			if mgsc.hooks[i] == nil {
				return nil, fmt.Errorf("ent: uninitialized hook (forgotten import ent/runtime?)")
			}
			mut = mgsc.hooks[i](mut)
		}
		v, err := mut.Mutate(ctx, mgsc.mutation)
		if err != nil {
			return nil, err
		}
...
func (mgsc *MiningGoodStockCreate) defaults() error {
	if _, ok := mgsc.mutation.CreatedAt(); !ok {
		if mininggoodstock.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized mininggoodstock.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := mininggoodstock.DefaultCreatedAt()
		mgsc.mutation.SetCreatedAt(v)
	}
	if _, ok := mgsc.mutation.UpdatedAt(); !ok {
		if mininggoodstock.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized mininggoodstock.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := mininggoodstock.DefaultUpdatedAt()
		mgsc.mutation.SetUpdatedAt(v)
	}
	if _, ok := mgsc.mutation.DeletedAt(); !ok {
		if mininggoodstock.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized mininggoodstock.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := mininggoodstock.DefaultDeletedAt()
		mgsc.mutation.SetDeletedAt(v)
	}
	if _, ok := mgsc.mutation.EntID(); !ok {
		if mininggoodstock.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized mininggoodstock.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := mininggoodstock.DefaultEntID()
		mgsc.mutation.SetEntID(v)
	}
	if _, ok := mgsc.mutation.GoodStockID(); !ok {
		if mininggoodstock.DefaultGoodStockID == nil {
			return fmt.Errorf("ent: uninitialized mininggoodstock.DefaultGoodStockID (forgotten import ent/runtime?)")
		}
	...
	if _, ok := mgsc.mutation.PoolGoodUserID(); !ok {
		if mininggoodstock.DefaultPoolGoodUserID == nil {
			return fmt.Errorf("ent: uninitialized mininggoodstock.DefaultPoolGoodUserID (forgotten import ent/runtime?)")
		}
...
func (mgsc *MiningGoodStockCreate) check() error {
	if _, ok := mgsc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "MiningGoodStock.created_at"`)}
	}
	if _, ok := mgsc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "MiningGoodStock.updated_at"`)}
	}
	if _, ok := mgsc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "MiningGoodStock.deleted_at"`)}
	}
	if _, ok := mgsc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "MiningGoodStock.ent_id"`)}
	}
	return nil
}
...
func (u *MiningGoodStockUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for MiningGoodStockCreate.OnConflict")
	}
...
func (u *MiningGoodStockUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the MiningGoodStockCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for MiningGoodStockCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
