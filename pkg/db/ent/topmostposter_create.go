...
func (tmpc *TopMostPosterCreate) Save(ctx context.Context) (*TopMostPoster, error) {
	...
	if len(tmpc.hooks) == 0 {
		...
		var mut Mutator = MutateFunc(func(ctx context.Context, m Mutation) (Value, error) {
			...
			tmpc.mutation = mutation
			if node, err = tmpc.sqlSave(ctx); err != nil {
				return nil, err
			}
			mutation.id = &node.ID
			mutation.done = true
		...
		for i := len(tmpc.hooks) - 1; i >= 0; i-- {
			if tmpc.hooks[i] == nil {
				return nil, fmt.Errorf("ent: uninitialized hook (forgotten import ent/runtime?)")
			}
			mut = tmpc.hooks[i](mut)
		}
		v, err := mut.Mutate(ctx, tmpc.mutation)
		if err != nil {
			return nil, err
		}
...
func (tmpc *TopMostPosterCreate) defaults() error {
	if _, ok := tmpc.mutation.CreatedAt(); !ok {
		if topmostposter.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized topmostposter.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := topmostposter.DefaultCreatedAt()
		tmpc.mutation.SetCreatedAt(v)
	}
	if _, ok := tmpc.mutation.UpdatedAt(); !ok {
		if topmostposter.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized topmostposter.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := topmostposter.DefaultUpdatedAt()
		tmpc.mutation.SetUpdatedAt(v)
	}
	if _, ok := tmpc.mutation.DeletedAt(); !ok {
		if topmostposter.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized topmostposter.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := topmostposter.DefaultDeletedAt()
		tmpc.mutation.SetDeletedAt(v)
	}
	if _, ok := tmpc.mutation.EntID(); !ok {
		if topmostposter.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized topmostposter.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := topmostposter.DefaultEntID()
		tmpc.mutation.SetEntID(v)
	}
	if _, ok := tmpc.mutation.TopMostID(); !ok {
		if topmostposter.DefaultTopMostID == nil {
			return fmt.Errorf("ent: uninitialized topmostposter.DefaultTopMostID (forgotten import ent/runtime?)")
		}
...
func (tmpc *TopMostPosterCreate) check() error {
	if _, ok := tmpc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "TopMostPoster.created_at"`)}
	}
	if _, ok := tmpc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "TopMostPoster.updated_at"`)}
	}
	if _, ok := tmpc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "TopMostPoster.deleted_at"`)}
	}
	if _, ok := tmpc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "TopMostPoster.ent_id"`)}
	}
	return nil
}
...
func (u *TopMostPosterUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for TopMostPosterCreate.OnConflict")
	}
...
func (u *TopMostPosterUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the TopMostPosterCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for TopMostPosterCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
