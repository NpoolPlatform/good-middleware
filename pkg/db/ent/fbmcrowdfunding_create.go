...
func (fcfc *FbmCrowdFundingCreate) defaults() error {
	if _, ok := fcfc.mutation.CreatedAt(); !ok {
		if fbmcrowdfunding.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized fbmcrowdfunding.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := fbmcrowdfunding.DefaultCreatedAt()
		fcfc.mutation.SetCreatedAt(v)
	}
	if _, ok := fcfc.mutation.UpdatedAt(); !ok {
		if fbmcrowdfunding.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized fbmcrowdfunding.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := fbmcrowdfunding.DefaultUpdatedAt()
		fcfc.mutation.SetUpdatedAt(v)
	}
	if _, ok := fcfc.mutation.DeletedAt(); !ok {
		if fbmcrowdfunding.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized fbmcrowdfunding.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := fbmcrowdfunding.DefaultDeletedAt()
		fcfc.mutation.SetDeletedAt(v)
	}
	if _, ok := fcfc.mutation.EntID(); !ok {
		if fbmcrowdfunding.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized fbmcrowdfunding.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := fbmcrowdfunding.DefaultEntID()
		fcfc.mutation.SetEntID(v)
	}
	if _, ok := fcfc.mutation.GoodID(); !ok {
		if fbmcrowdfunding.DefaultGoodID == nil {
			return fmt.Errorf("ent: uninitialized fbmcrowdfunding.DefaultGoodID (forgotten import ent/runtime?)")
		}
	...
	if _, ok := fcfc.mutation.DepositCoinTypeID(); !ok {
		if fbmcrowdfunding.DefaultDepositCoinTypeID == nil {
			return fmt.Errorf("ent: uninitialized fbmcrowdfunding.DefaultDepositCoinTypeID (forgotten import ent/runtime?)")
		}
...
func (fcfc *FbmCrowdFundingCreate) check() error {
	if _, ok := fcfc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "FbmCrowdFunding.created_at"`)}
	}
	if _, ok := fcfc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "FbmCrowdFunding.updated_at"`)}
	}
	if _, ok := fcfc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "FbmCrowdFunding.deleted_at"`)}
	}
	if _, ok := fcfc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "FbmCrowdFunding.ent_id"`)}
	}
	return nil
}
...
func (u *FbmCrowdFundingUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for FbmCrowdFundingCreate.OnConflict")
	}
...
func (u *FbmCrowdFundingUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the FbmCrowdFundingCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for FbmCrowdFundingCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
