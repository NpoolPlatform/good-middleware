...
func (adsc *AppDelegatedStakingCreate) defaults() error {
	if _, ok := adsc.mutation.CreatedAt(); !ok {
		if appdelegatedstaking.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized appdelegatedstaking.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := appdelegatedstaking.DefaultCreatedAt()
		adsc.mutation.SetCreatedAt(v)
	}
	if _, ok := adsc.mutation.UpdatedAt(); !ok {
		if appdelegatedstaking.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized appdelegatedstaking.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := appdelegatedstaking.DefaultUpdatedAt()
		adsc.mutation.SetUpdatedAt(v)
	}
	if _, ok := adsc.mutation.DeletedAt(); !ok {
		if appdelegatedstaking.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized appdelegatedstaking.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := appdelegatedstaking.DefaultDeletedAt()
		adsc.mutation.SetDeletedAt(v)
	}
	if _, ok := adsc.mutation.EntID(); !ok {
		if appdelegatedstaking.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized appdelegatedstaking.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := appdelegatedstaking.DefaultEntID()
		adsc.mutation.SetEntID(v)
	}
	if _, ok := adsc.mutation.AppGoodID(); !ok {
		if appdelegatedstaking.DefaultAppGoodID == nil {
			return fmt.Errorf("ent: uninitialized appdelegatedstaking.DefaultAppGoodID (forgotten import ent/runtime?)")
		}
...
func (adsc *AppDelegatedStakingCreate) check() error {
	if _, ok := adsc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "AppDelegatedStaking.created_at"`)}
	}
	if _, ok := adsc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "AppDelegatedStaking.updated_at"`)}
	}
	if _, ok := adsc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "AppDelegatedStaking.deleted_at"`)}
	}
	if _, ok := adsc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "AppDelegatedStaking.ent_id"`)}
	}
	return nil
}
...
func (u *AppDelegatedStakingUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for AppDelegatedStakingCreate.OnConflict")
	}
...
func (u *AppDelegatedStakingUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the AppDelegatedStakingCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for AppDelegatedStakingCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
