...
func (agdnc *AppGoodDisplayNameCreate) Save(ctx context.Context) (*AppGoodDisplayName, error) {
	...
	if err := agdnc.defaults(); err != nil {
		return nil, err
	}
	if len(agdnc.hooks) == 0 {
		if err = agdnc.check(); err != nil {
			return nil, err
		}
		node, err = agdnc.sqlSave(ctx)
	} else {
		var mut Mutator = MutateFunc(func(ctx context.Context, m Mutation) (Value, error) {
			...
			agdnc.mutation = mutation
			if node, err = agdnc.sqlSave(ctx); err != nil {
				return nil, err
			}
			mutation.id = &node.ID
			mutation.done = true
		...
		for i := len(agdnc.hooks) - 1; i >= 0; i-- {
			if agdnc.hooks[i] == nil {
				return nil, fmt.Errorf("ent: uninitialized hook (forgotten import ent/runtime?)")
			}
			mut = agdnc.hooks[i](mut)
		}
		v, err := mut.Mutate(ctx, agdnc.mutation)
		if err != nil {
			return nil, err
		}
...
func (agdnc *AppGoodDisplayNameCreate) defaults() error {
	if _, ok := agdnc.mutation.CreatedAt(); !ok {
		if appgooddisplayname.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized appgooddisplayname.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := appgooddisplayname.DefaultCreatedAt()
		agdnc.mutation.SetCreatedAt(v)
	}
	if _, ok := agdnc.mutation.UpdatedAt(); !ok {
		if appgooddisplayname.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized appgooddisplayname.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := appgooddisplayname.DefaultUpdatedAt()
		agdnc.mutation.SetUpdatedAt(v)
	}
	if _, ok := agdnc.mutation.DeletedAt(); !ok {
		if appgooddisplayname.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized appgooddisplayname.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := appgooddisplayname.DefaultDeletedAt()
		agdnc.mutation.SetDeletedAt(v)
	}
	if _, ok := agdnc.mutation.EntID(); !ok {
		if appgooddisplayname.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized appgooddisplayname.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := appgooddisplayname.DefaultEntID()
		agdnc.mutation.SetEntID(v)
	}
	if _, ok := agdnc.mutation.AppGoodID(); !ok {
		if appgooddisplayname.DefaultAppGoodID == nil {
			return fmt.Errorf("ent: uninitialized appgooddisplayname.DefaultAppGoodID (forgotten import ent/runtime?)")
		}
...
func (agdnc *AppGoodDisplayNameCreate) check() error {
	if _, ok := agdnc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "AppGoodDisplayName.created_at"`)}
	}
	if _, ok := agdnc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "AppGoodDisplayName.updated_at"`)}
	}
	if _, ok := agdnc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "AppGoodDisplayName.deleted_at"`)}
	}
	if _, ok := agdnc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "AppGoodDisplayName.ent_id"`)}
	}
	return nil
}
...
func (u *AppGoodDisplayNameUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for AppGoodDisplayNameCreate.OnConflict")
	}
...
func (u *AppGoodDisplayNameUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the AppGoodDisplayNameCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for AppGoodDisplayNameCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
