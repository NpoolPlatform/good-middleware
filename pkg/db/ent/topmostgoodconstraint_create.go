...
func (tmgcc *TopMostGoodConstraintCreate) Save(ctx context.Context) (*TopMostGoodConstraint, error) {
	...
	if err := tmgcc.defaults(); err != nil {
		return nil, err
	}
	if len(tmgcc.hooks) == 0 {
		if err = tmgcc.check(); err != nil {
			return nil, err
		}
		node, err = tmgcc.sqlSave(ctx)
	} else {
		var mut Mutator = MutateFunc(func(ctx context.Context, m Mutation) (Value, error) {
			...
			tmgcc.mutation = mutation
			if node, err = tmgcc.sqlSave(ctx); err != nil {
				return nil, err
			}
			mutation.id = &node.ID
			mutation.done = true
		...
		for i := len(tmgcc.hooks) - 1; i >= 0; i-- {
			if tmgcc.hooks[i] == nil {
				return nil, fmt.Errorf("ent: uninitialized hook (forgotten import ent/runtime?)")
			}
			mut = tmgcc.hooks[i](mut)
		}
		v, err := mut.Mutate(ctx, tmgcc.mutation)
		if err != nil {
			return nil, err
		}
...
func (tmgcc *TopMostGoodConstraintCreate) defaults() error {
	if _, ok := tmgcc.mutation.CreatedAt(); !ok {
		if topmostgoodconstraint.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized topmostgoodconstraint.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := topmostgoodconstraint.DefaultCreatedAt()
		tmgcc.mutation.SetCreatedAt(v)
	}
	if _, ok := tmgcc.mutation.UpdatedAt(); !ok {
		if topmostgoodconstraint.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized topmostgoodconstraint.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := topmostgoodconstraint.DefaultUpdatedAt()
		tmgcc.mutation.SetUpdatedAt(v)
	}
	if _, ok := tmgcc.mutation.DeletedAt(); !ok {
		if topmostgoodconstraint.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized topmostgoodconstraint.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := topmostgoodconstraint.DefaultDeletedAt()
		tmgcc.mutation.SetDeletedAt(v)
	}
	if _, ok := tmgcc.mutation.EntID(); !ok {
		if topmostgoodconstraint.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized topmostgoodconstraint.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := topmostgoodconstraint.DefaultEntID()
		tmgcc.mutation.SetEntID(v)
	}
	if _, ok := tmgcc.mutation.TopMostGoodID(); !ok {
		if topmostgoodconstraint.DefaultTopMostGoodID == nil {
			return fmt.Errorf("ent: uninitialized topmostgoodconstraint.DefaultTopMostGoodID (forgotten import ent/runtime?)")
		}
...
func (tmgcc *TopMostGoodConstraintCreate) check() error {
	if _, ok := tmgcc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "TopMostGoodConstraint.created_at"`)}
	}
	if _, ok := tmgcc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "TopMostGoodConstraint.updated_at"`)}
	}
	if _, ok := tmgcc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "TopMostGoodConstraint.deleted_at"`)}
	}
	if _, ok := tmgcc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "TopMostGoodConstraint.ent_id"`)}
	}
	return nil
}
...
func (u *TopMostGoodConstraintUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for TopMostGoodConstraintCreate.OnConflict")
	}
...
func (u *TopMostGoodConstraintUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the TopMostGoodConstraintCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for TopMostGoodConstraintCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
