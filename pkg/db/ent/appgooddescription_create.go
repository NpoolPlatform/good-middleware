...
func (agdc *AppGoodDescriptionCreate) Save(ctx context.Context) (*AppGoodDescription, error) {
	...
	if len(agdc.hooks) == 0 {
		...
		var mut Mutator = MutateFunc(func(ctx context.Context, m Mutation) (Value, error) {
			...
			agdc.mutation = mutation
			if node, err = agdc.sqlSave(ctx); err != nil {
				return nil, err
			}
			mutation.id = &node.ID
			mutation.done = true
		...
		for i := len(agdc.hooks) - 1; i >= 0; i-- {
			if agdc.hooks[i] == nil {
				return nil, fmt.Errorf("ent: uninitialized hook (forgotten import ent/runtime?)")
			}
			mut = agdc.hooks[i](mut)
		}
		v, err := mut.Mutate(ctx, agdc.mutation)
		if err != nil {
			return nil, err
		}
...
func (agdc *AppGoodDescriptionCreate) defaults() error {
	if _, ok := agdc.mutation.CreatedAt(); !ok {
		if appgooddescription.DefaultCreatedAt == nil {
			return fmt.Errorf("ent: uninitialized appgooddescription.DefaultCreatedAt (forgotten import ent/runtime?)")
		}
		v := appgooddescription.DefaultCreatedAt()
		agdc.mutation.SetCreatedAt(v)
	}
	if _, ok := agdc.mutation.UpdatedAt(); !ok {
		if appgooddescription.DefaultUpdatedAt == nil {
			return fmt.Errorf("ent: uninitialized appgooddescription.DefaultUpdatedAt (forgotten import ent/runtime?)")
		}
		v := appgooddescription.DefaultUpdatedAt()
		agdc.mutation.SetUpdatedAt(v)
	}
	if _, ok := agdc.mutation.DeletedAt(); !ok {
		if appgooddescription.DefaultDeletedAt == nil {
			return fmt.Errorf("ent: uninitialized appgooddescription.DefaultDeletedAt (forgotten import ent/runtime?)")
		}
		v := appgooddescription.DefaultDeletedAt()
		agdc.mutation.SetDeletedAt(v)
	}
	if _, ok := agdc.mutation.EntID(); !ok {
		if appgooddescription.DefaultEntID == nil {
			return fmt.Errorf("ent: uninitialized appgooddescription.DefaultEntID (forgotten import ent/runtime?)")
		}
		v := appgooddescription.DefaultEntID()
		agdc.mutation.SetEntID(v)
	}
	if _, ok := agdc.mutation.AppGoodID(); !ok {
		if appgooddescription.DefaultAppGoodID == nil {
			return fmt.Errorf("ent: uninitialized appgooddescription.DefaultAppGoodID (forgotten import ent/runtime?)")
		}
...
func (agdc *AppGoodDescriptionCreate) check() error {
	if _, ok := agdc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`ent: missing required field "AppGoodDescription.created_at"`)}
	}
	if _, ok := agdc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "AppGoodDescription.updated_at"`)}
	}
	if _, ok := agdc.mutation.DeletedAt(); !ok {
		return &ValidationError{Name: "deleted_at", err: errors.New(`ent: missing required field "AppGoodDescription.deleted_at"`)}
	}
	if _, ok := agdc.mutation.EntID(); !ok {
		return &ValidationError{Name: "ent_id", err: errors.New(`ent: missing required field "AppGoodDescription.ent_id"`)}
	}
	return nil
}
...
func (u *AppGoodDescriptionUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for AppGoodDescriptionCreate.OnConflict")
	}
...
func (u *AppGoodDescriptionUpsertBulk) Exec(ctx context.Context) error {
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("ent: OnConflict was set for builder %d. Set it on the AppGoodDescriptionCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("ent: missing options for AppGoodDescriptionCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
