# Npool good middleware

[![Test](https://github.com/NpoolPlatform/good-middleware/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/good-middleware/actions/workflows/main.yml)
...
* make good-middleware ```单独编译服务```
* make good-middleware-image ```单独生成服务镜像```
