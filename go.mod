module github.com/NpoolPlatform/good-middleware
...
require (
	...
	github.com/NpoolPlatform/libent-cruder v0.0.0-20240319090142-f563e5c77a1e
	github.com/NpoolPlatform/message v0.0.0-20240315075427-4dc09cd75bd3
